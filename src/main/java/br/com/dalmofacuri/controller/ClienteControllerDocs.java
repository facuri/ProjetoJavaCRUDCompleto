...
public interface ClienteControllerDocs {
	...
	@ApiResponses(value = {
		@ApiResponse(code = 200, message = "Retorna todos os registros dos clientes"),
	...
	@ApiResponses(value = {
		@ApiResponse(code = 200, message = "Sucesso cliente encontrado"),
	...
	@ApiResponses(value = {
		@ApiResponse(code = 200, message = "Sucesso cliente atualizado"),
	...
	@ApiResponses(value = {
			@ApiResponse(code = 204, message = "Sucesso cliente deletado"),
			@ApiResponse(code = 404, message = "Código de erro cliente não encontrado"),
		})
	    void delete(Long id);
